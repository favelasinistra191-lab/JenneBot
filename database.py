...
# Pega a URL do banco de dados (que você colocou no Render/Supabase)
DATABASE_URL = os.getenv("DATABASE_URL")

if not DATABASE_URL:
    raise ValueError("A variável de ambiente DATABASE_URL não foi configurada!")

# Configuração do Engine com tentativas de reconexão
engine = None
tentativas = 10
tempo_espera = 5
...
def garantir_usuario(user_id: int, nome: str, username: str):
    """Garante que o usuário existe na tabela, inserindo se não existir."""
