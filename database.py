...
# Pega a URL e garante que se for o host direto, a gente força a compatibilidade
DATABASE_URL = os.getenv("DATABASE_URL")

if not DATABASE_URL:
    raise ValueError("A variável de ambiente DATABASE_URL não foi configurada!")

# Se o usuário ainda estiver usando o host padrão do Supabase, vamos garantir o sslmode
