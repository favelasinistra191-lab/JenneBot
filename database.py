...
DATABASE_URL = os.getenv("DATABASE_URL", "") # Coloque sua nova URL aqui ou nas variáveis de ambiente do Render
...
def adicionar_gg_pendente(bin_gg: str, banco: str, conteudo: str, actor: int):
    ...
    try:
        ...
        if "read-only transaction" in str(e):
            print("Erro de banco somente-leitura ao adicionar GG. Ignorando.")
            return None, None
        else: raise e
